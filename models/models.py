...
class Ingredient(db.Model):
    ...
    def calculer_prix(self, quantite_native: float) -> float:
        ...
        Returns:
            Prix en euros, arrondi à 2 décimales
        """
    ...
    def get_saisons(self) -> list:
        ...
        Returns:
            Liste de saisons ou [] si disponible toute l'année
        """
    ...
    def set_saisons(self, saisons: list):
        ...
        Args:
            saisons: Liste de saisons valides. Une liste vide signifie toute l'année.
        """
...
class Recette(db.Model):
    ...
    def calculer_score_saisonnier(self) -> dict:
        ...
        Returns:
            Dict avec score (0-100), saison_optimale et details
        """
        from utils.saisons import get_saison_actuelle
